            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.updateMas', $data->id) }}" method="POST">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group mb-3">
                                    <input type="text" id="nkk" class="form-control" placeholder="NKK" name="nkkip" value="{{ $data->nkkip }}" maxlength="16">
                                    @error('nkkip')
                                        <small>{{ $message }}</small>
                                    @enderror
                                </div>
                    ...
                    <div class="form-actions d-flex justify-content-end">
                        ...
                        <a href="{{ route('admin.listMas') }}" class="btn btn-light-primary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
