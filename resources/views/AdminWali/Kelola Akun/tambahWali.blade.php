...
<div class="d-flex justify-content-center">
    <div class="card p-4" style="width: 70%">
        <div class="card-content">
            <div class="card-body">
                <h4 class="card-title" style="text-align: center; margin-bottom: 20px;">Form Tambah Wali</h4>
                <form class="form" method="POST" action="{{ route('admin.inputWali') }}">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="form-actions d-flex justify-content-end">
                        ...
                        <a href="{{ route('admin.listWali') }}" class="btn btn-light-primary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
