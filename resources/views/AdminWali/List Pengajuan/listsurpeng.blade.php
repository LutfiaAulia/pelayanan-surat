        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Pengajuan Surat Penghasilan</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 140px; text-align: center;" >
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('admin.verifikasisurpeng', ['id_pengajuan' => $item['id_pengajuan']]) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                                @if ($item['status_pengajuan'] != 'Mengajukan' && $item['status_pengajuan'] != 'Ditolak')
                                                    <form action="{{ route('upload.suratpot', ['id_pengajuan' => $item['id_pengajuan']]) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
