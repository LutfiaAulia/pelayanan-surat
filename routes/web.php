...
Route::middleware(['auth'])->group(function () {
    ...
    Route::put('/adminwali/listpengajuan/generate', [PengajuanController::class, 'verifsktm'])->name('adminwali.listpengajuan.generate')->middleware('userAkses:admin');
    ...
    Route::put('/adminwali/listpengajuan/verifikasi/{id_pengajuan}', [PengajuanController::class, 'verifpot'])->name('adminwali.listpengajuan.verifikasipot')->middleware('userAkses:admin');
